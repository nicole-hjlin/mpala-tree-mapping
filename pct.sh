...
python3 -m pct_main --exp_name test --eval True --batch_size 32 --test_batch_size 32 --epochs 1 --num_points 1000 --min_points 1000 --dropout 0.5 --data_dir ../data/MpalaForestGEO_LasClippedtoTreePolygons --label_path labels_test.csv