...
python3 -m main --name test --min_points 1000 --learning_rate 1e-4 --epochs 10 --batch_size 64 --data_dir ../data/MpalaForestGEO_LasClippedtoTreePolygons --label_path labels.csv --top_species 5
